...
// ===== Wajib login sebagai pembeli untuk lanjut checkout =====
if (!$userLogin) {
...
<script>
  // Ditunggu sampai DOMContentLoaded supaya js/main.js (dimuat di footer) sudah selesai
  // memuat keranjangBelanja dari localStorage sebelum ringkasan dirender di sini.
