...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if ($namaPenerima === '' || $alamatPengiriman === '') {
    ...
    // ===== KEAMANAN: jangan percaya harga/nama dari client, ambil ulang dari database by id =====
    $items = [];
    $subtotal = 0;
    ...
    if (count($items) === 0) {
      ...
      // ===== KEAMANAN: validasi ulang kode promo di server, jangan percaya persen dari client =====
      $persenDiskon = 0;
      $kodePromoValid = null;
      if ($kodePromoInput !== '') {
