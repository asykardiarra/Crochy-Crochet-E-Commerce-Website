...
// ===== Label & warna status pesanan (dipakai juga di seller/pesanan.php) =====
$labelStatus = [
...
// ===== Ambil semua pesanan milik user yang login, beserta detail item =====
$daftarPesanan = [];
